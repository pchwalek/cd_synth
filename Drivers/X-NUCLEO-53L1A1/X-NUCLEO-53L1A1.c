...
/**
 *@mainpage
 *@image html VL53L1A1_board.jpg "X-NUCLEO-53L1A1 Expansion Board"

  @section Quick BSP links
  - @ref XNUCLEO53L1A1_Interface
  - Board information and configuration @ref XNUCLEO53L1A1_Board
  - Go to Modules panes


  @section XNUCLEO53L1A1_usage How to use X-NUCLEO-53L1A1 BSP ?
  ## Multiple family project ##
   X-NUCLEO-53L1A1 BSP supports multiple STM32 families through unique "stm32xxx_hal.h".
   This file redirects to the targeted stm32 HAL.
   @note This file can also be used to place any customization defines

  @section XNUCLEO53L1A1_conf  How to configure X-NUCLEO-53L1A1 BSP ?
  ## configuration ##
    see @ref VL53L1A1_config
...
/**
 * @defgroup XNUCLEO53L1A1_Board X-NUCLEO-53L1A1 Expansion Board
 * @{
 */
