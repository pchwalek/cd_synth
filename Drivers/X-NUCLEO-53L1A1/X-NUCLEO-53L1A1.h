...
#   define VL53L1A1_GPIO1_C_GPIO_PORT   GPIOA
#   define VL53L1A1_GPIO1_C_CLK_ENABLE  __GPIOA_CLK_ENABLE
#   define VL53L1A1_GPIO1_C_GPIO_PIN    GPIO_PIN_4
#   if defined(STM32F401xE) || defined(STM32L476xx) || defined(STM32F401xC)
#       define VL53L1A1_GPIO1_C_INTx       EXTI4_IRQn
#       define VL53L1A1_EXTI4_USE_PIN      VL53L1A1_GPIO1_C_GPIO_PIN
#   endif
#   if defined(STM32L053xx)
#       define VL53L1A1_GPIO1_C_INTx        EXTI4_15_IRQn
#       define VL53L1A1_EXTI4_15_USE_PIN    VL53L1A1_GPIO1_C_GPIO_PIN
#   endif // STM32L053xx
#else
#   define VL53L1A1_GPIO1_C_CLK_ENABLE  __GPIOC_CLK_ENABLE
#   define VL53L1A1_GPIO1_C_GPIO_PORT   GPIOC
#   define VL53L1A1_GPIO1_C_GPIO_PIN    GPIO_PIN_1
#   if defined(STM32F401xE) || defined(STM32L476xx) || defined(STM32F401xC)
#       define VL53L1A1_GPIO1_C_INTx        EXTI1_IRQn
#       define VL53L1A1_EXTI1_USE_PIN       VL53L1A1_GPIO1_C_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L1A1_GPIO1_C_INTx        EXTI0_1_IRQn
#       define VL53L1A1_EXTI0_1_USE_PIN     VL53L1A1_GPIO1_C_GPIO_PIN
#   endif // STM32L053xx
#endif
...
#   if defined(STM32F401xE) || defined(STM32L476xx) || defined(STM32F401xC)
#       define VL53L1A1_GPIO1_L_INTx       EXTI9_5_IRQn
#       define VL53L1A1_EXTI9_5_USE_PIN    VL53L1A1_GPIO1_L_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L1A1_GPIO1_L_INTx        EXTI4_15_IRQn
#       define VL53L1A1_EXTI4_15_USE_PIN_2   VL53L1A1_GPIO1_L_GPIO_PIN
...
#   endif // STM32L053xx
#else
#   define VL53L1A1_GPIO1_L_GPIO_PORT   GPIOA
#   define VL53L1A1_GPIO1_L_CLK_ENABLE  __GPIOA_CLK_ENABLE
#   define VL53L1A1_GPIO1_L_GPIO_PIN    GPIO_PIN_9
...
#   if defined(STM32F401xE) || defined(STM32L476xx) || defined(STM32F401xC)
#       define VL53L1A1_GPIO1_R_INTx       EXTI15_10_IRQn
#       define VL53L1A1_EXTI15_10_USE_PIN  VL53L1A1_GPIO1_R_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L1A1_GPIO1_R_INTx        EXTI4_15_IRQn
#       define VL53L1A1_EXTI4_15_USE_PIN_3  VL53L1A1_GPIO1_R_GPIO_PIN
#       ifndef VL53L1A1_EXTI4_15_USE_PIN
...
#   endif // STM32L053xx
#else
#   define VL53L1A1_GPIO1_R_GPIO_PORT   GPIOB
#   define VL53L1A1_GPIO1_R_CLK_ENABLE  __GPIOB_CLK_ENABLE
#   define VL53L1A1_GPIO1_R_GPIO_PIN    GPIO_PIN_5
#   if defined(STM32F401xE) || defined(STM32L476xx) || defined(STM32F401xC)
#       define VL53L1A1_GPIO1_R_INTx       EXTI9_5_IRQn //  conflict with VL53L1A1_GPIO1_L any option
#       define VL53L1A1_EXTI9_5_USE_PIN    VL53L1A1_GPIO1_R_GPIO_PIN
#   endif // STM32F401xE
#   if defined(STM32L053xx)
#       define VL53L1A1_GPIO1_R_INTx        EXTI4_15_IRQn
#       define VL53L1A1_EXTI4_15_USE_PIN_3  VL53L1A1_GPIO1_R_GPIO_PIN
